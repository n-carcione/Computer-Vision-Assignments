...
def epipolarMatchGUI(I1, I2, F):
    ...
    pts1 = np.empty((0,2), int)
    pts2 = np.empty((0,2), int)
    num_points = 1
    while True:
        plt.sca(ax1)
        ...
        # Uncomment the below when you want to save a new set of 10 points
        # if num_points <= 10:
        #     num_points += 1
        #     pt1 = np.array(( [x, y] ))
        #     pt2 = np.array(( [x2, y2] ))
        #     pts1 = np.vstack((pts1, pt1))
        #     pts2 = np.vstack((pts2, pt2))
