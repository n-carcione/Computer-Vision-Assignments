...
# call my own warping function
my_warped = warpA.warp(im_gray, A, output_shape)

# display my warped image in the bottom right subplot
axes[1, 1].imshow(my_warped, cmap=plt.get_cmap('gray'))
