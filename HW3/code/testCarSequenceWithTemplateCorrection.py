...
#Load car sequence, given initial rectangle, and rectangles from base case
seq = np.load("../data/carseq.npy")
old_rects = np.load("../results/carseqrects.npy")
rect = [59, 116, 145, 151]
...
# np.save('../results/carseqrects-wcrt.npy',rects_list)